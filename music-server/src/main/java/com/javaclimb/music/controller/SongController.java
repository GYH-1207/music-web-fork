...
//        获取前端传来的数据
    ...
    @RequestMapping(value = "/singer/detailClient", method = RequestMethod.GET)
    public Object songOfSingerIdClient(HttpServletRequest request) {
        ...
        return songService.songOfSingerIdClient(Integer.parseInt(userId), Integer.parseInt(singerId));
    }
...
//        删掉歌曲地址资源
    ...
    public Object detailClient(HttpServletRequest request) {
        String userId = request.getParameter("userId");
        String songId = request.getParameter("songId");
